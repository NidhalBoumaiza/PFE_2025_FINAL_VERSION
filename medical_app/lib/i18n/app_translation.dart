...
class LanguageService extends Translations {
  ...
  Map<String, Map<String, String>> get keys => {
    'fr_FR': {
      ...
      'updated': 'Mis à jour',
      'refilled': 'Renouvelé',
      'dossier_update': 'Mise à jour du dossier',
      'notification': 'Notification',
      'ratings': 'Évaluations',
      'error_invalid_user_data': 'Erreur: données utilisateur invalides',
      'error_user_not_found': 'Erreur: utilisateur non trouvé',
      'error_loading_notifications': 'Erreur lors du chargement des notifications',
      'error_marking_notifications_read': 'Erreur lors du marquage des notifications comme lues',
      ...
      'at': 'à',
      'appointment_accepted_message': 'Dr. {0} a accepté votre rendez-vous du {1}',
      'appointment_rejected_message': 'Dr. {0} a refusé votre rendez-vous du {1}',
      'appointment_cancelled_message': 'Dr. {0} a annulé votre rendez-vous du {1}',
      'prescription_created_message': 'Dr. {0} a créé une nouvelle ordonnance pour vous',
      'prescription_updated_message': 'Dr. {0} a mis à jour votre ordonnance: {1}',
