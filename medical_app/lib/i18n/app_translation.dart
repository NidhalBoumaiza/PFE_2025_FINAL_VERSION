  ...
  Map<String, Map<String, String>> get keys => {
    'fr_FR': {
      ...
      'delete_account_description':
          'La suppression permanente de votre compte supprimera toutes vos données, y compris les rendez-vous, les messages, les ordonnances et les dossiers médicaux.',
      'confirm_password_to_delete': 'Confirmez votre mot de passe pour supprimer le compte',
      ...
      'ai_chat_title': 'Chat avec l\'Assistant IA Médical',
      'ai_type_message': 'Tapez votre message...',
      'ai_send': 'Envoyer',
      'ai_attach_image': 'Joindre une image',
      'ai_attach_pdf': 'Joindre un PDF',
      'ai_attach_file': 'Joindre un fichier',
      'ai_select_image': 'Sélectionner une image',
      'ai_select_pdf': 'Sélectionner un PDF',
      'ai_camera': 'Appareil photo',
      'ai_gallery': 'Galerie',
      'ai_image_uploaded': 'Image téléchargée pour analyse',
      'ai_analyze_medical_images': 'Analyser les images médicales',
      'ai_analyze_medical_docs': 'Analyser les documents médicaux',
      'ai_image_prompt_title': 'Description de l\'analyse',
      'ai_image_prompt_description': 'Décrivez ce que vous voulez que l\'IA analyse dans cette image:',
      'ai_image_prompt_hint': 'ex: "Analyser cette radiographie pulmonaire" ou "Identifier toute anomalie dans cette IRM"',
      'ai_analyze': 'Analyser',
      'ai_pdf_uploaded': 'Document PDF téléchargé pour analyse',
      'ai_text_response': 'Je suis un assistant IA médical. Pour une analyse détaillée, veuillez télécharger des images ou des documents PDF.',
    ...
    'en_US': {
      ...
      'ai_chatbot': 'Chatbot IA',
      'ai_chat_title': 'Chat with Medical AI Assistant',
      'ai_type_message': 'Type your message...',
      'ai_send': 'Send',
      'ai_attach_image': 'Attach an image',
      'ai_attach_pdf': 'Attach a PDF',
      'ai_attach_file': 'Attach a file',
      'ai_select_image': 'Select an image',
      'ai_select_pdf': 'Select a PDF',
      'ai_camera': 'Camera',
      'ai_gallery': 'Gallery',
      'ai_image_uploaded': 'Image uploaded for analysis',
      'ai_analyze_medical_images': 'Analyze medical images',
      'ai_analyze_medical_docs': 'Analyze medical documents',
      'ai_image_prompt_title': 'Analysis Description',
      'ai_image_prompt_description': 'Describe what you want the AI to analyze in this image:',
      'ai_image_prompt_hint': 'e.g., "Analyze this chest X-ray" or "Identify any abnormalities in this MRI"',
      'ai_analyze': 'Analyze',
      'ai_pdf_uploaded': 'PDF document uploaded for analysis',
      'ai_text_response': 'I am a medical AI assistant. For detailed analysis, please upload images or PDF documents.',
    ...
    'ar_AR': {
      ...
      'ai_chatbot': 'مساعد الدردشة الذكاء الاصطناعي',
      'ai_chat_title': 'محادثة مع مساعد الذكاء الطبي',
      'ai_type_message': 'اكتب رسالتك...',
      'ai_send': 'إرسال',
      'ai_attach_image': 'إرفاق صورة',
      'ai_attach_pdf': 'إرفاق ملف PDF',
      'ai_attach_file': 'إرفاق ملف',
      'ai_select_image': 'اختر صورة',
      'ai_select_pdf': 'اختر ملف PDF',
      'ai_camera': 'كاميرا',
      'ai_gallery': 'معرض الصور',
      'ai_image_uploaded': 'تم رفع صورة للتحليل',
      'ai_analyze_medical_images': 'تحليل الصور الطبية',
      'ai_analyze_medical_docs': 'تحليل الوثائق الطبية',
      'ai_image_prompt_title': 'وصف التحليل',
      'ai_image_prompt_description': 'صف ما تريد من مساعد الذكاء الطبي تحليله في هذه الصورة:',
      'ai_image_prompt_hint': 'مثال: "تحليل هذه الأشعة السينية للصدر" أو "تحديد أي تشوهات في هذا التصوير بالرنين المغناطيسي"',
      'ai_analyze': 'تحليل',
      'ai_pdf_uploaded': 'تم رفع ملف PDF للتحليل',
      'ai_text_response': 'أنا مساعد ذكاء اصطناعي طبي. للتحليل المفصل، يرجى رفع الصور أو ملف PDF.',
